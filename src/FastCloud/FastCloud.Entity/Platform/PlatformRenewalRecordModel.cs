...
/// <summary>
/// <see cref="PlatformRenewalRecordModel"/> 平台续费记录表Model类
/// </summary>
[SugarTable("PlatformRenewalRecord", "平台续费记录表")]
[SugarDbType(DatabaseTypeEnum.FastCloud)]
public class PlatformRenewalRecordModel : SnowflakeKeyEntity
{
    /// <summary>
    /// 平台Id
    /// </summary>
    ...
    /// 续费时间
    /// </summary>
    [SugarColumn(ColumnDescription = "续费时间")]
