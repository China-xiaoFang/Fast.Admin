...
internal static partial class MenuSeedData
{
        ...
        string userName, DateTime dateTime)
    {
        ...
        var userMenuModel = new MenuModel
        {
            ...
            HasWeb = true,
            WebIcon = "user",
            WebRouter = "/platform/system/user/page",
            WebComponent = "platform/system/user/index",
            HasMobile = true,
            MobileIcon = "https://image.fastdotnet.com/menu/mobile/user.png",
            MobileRouter = "pages_platform/system/user/page/index",
        ...
        var editionMenuModel = new MenuModel
        {
            ...
            HasWeb = true,
            WebIcon = "edition",
            WebRouter = "/platform/system/edition/page",
            WebComponent = "platform/system/edition/index",
            HasMobile = true,
            MobileIcon = "https://image.fastdotnet.com/menu/mobile/edition.png",
            MobileRouter = "pages_platform/system/edition/page/index",
            Visible = YesOrNotEnum.Y,
            Sort = menuSort,
            Status = CommonStatusEnum.Enable,
            CreatedUserId = userId,
        ...
        var dbMenuModel = new MenuModel
        {
            ...
            HasWeb = true,
            WebIcon = "database",
            WebRouter = "/platform/system/database/page",
            WebComponent = "platform/system/database/index",
            HasMobile = true,
            MobileIcon = "https://image.fastdotnet.com/menu/mobile/database.png",
            MobileRouter = "pages_platform/system/database/page/index",
            Visible = YesOrNotEnum.Y,
            Sort = menuSort,
            Status = CommonStatusEnum.Enable,
            CreatedUserId = userId,
        ...
        var appMenuModel = new MenuModel
        {
            ...
            HasWeb = true,
            WebIcon = "app",
            WebRouter = "/platform/system/app/page",
            WebComponent = "platform/system/app/index",
            HasMobile = true,
            MobileIcon = "https://image.fastdotnet.com/menu/mobile/app.png",
            MobileRouter = "pages_platform/system/app/page/index",
            Visible = YesOrNotEnum.Y,
            Sort = menuSort,
            Status = CommonStatusEnum.Enable,
            CreatedUserId = userId,
