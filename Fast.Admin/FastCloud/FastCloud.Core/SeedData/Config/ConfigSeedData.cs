        ...
        await db.Insertable(new List<ConfigModel>
            {
                new()
                {
                    ...
                    ConfigCode = ConfigConst.RequestTimeout,
                    ConfigName = "请求超时时间（毫秒）",
                    ConfigValue = "6000",
                    Remark = "接口请求超时时间，默认 6000 毫秒。",
                ...
                {
                    Id = YitIdHelper.NextId(),
                    ConfigCode = ConfigConst.RequestEncipher,
                    ConfigName = "请求加密",
                    ConfigValue = "True",
                    Remark = "True：加密；False：默认；",
                    CreatedUserId = userId,
                    CreatedUserName = userName,
                    CreatedTime = dateTime
                },
