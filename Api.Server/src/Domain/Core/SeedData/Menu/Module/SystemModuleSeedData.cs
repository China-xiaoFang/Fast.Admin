...
internal static partial class MenuSeedData
{
    ...
    private static async Task SystemModuleSeedData(ISqlSugarClient db, ApplicationModel applicationModel, DateTime dateTime)
    {
        ...
        var fileMenuModel = new MenuModel
        {
            ...
            ParentIds = [0],
            MenuType = MenuTypeEnum.Menu,
            RoleType = RoleTypeEnum.Admin | RoleTypeEnum.IT | RoleTypeEnum.HR | RoleTypeEnum.Finance | RoleTypeEnum.Operator,
            HasDesktop = true,
            DesktopIcon = "desktop",
            HasWeb = true,
        ...
        var appMenuModel = new MenuModel
        {
            ...
            WebRouter = "/system/application",
            WebComponent = "system/application/index",
            WebTab = true,
            WebKeepAlive = true,
            HasMobile = true,
            MobileIcon = "https://image.fastdotnet.com/menu/mobile/app.png",
            MobileRouter = "pages_system/application/page/index",
            Visible = true,
            Sort = menuSort,
            Status = CommonStatusEnum.Enable,
            CreatedTime = dateTime
        ...
        var positionMenuModel = new MenuModel
        {
            ...
            MenuType = MenuTypeEnum.Menu,
            RoleType = RoleTypeEnum.Admin | RoleTypeEnum.HR,
            HasDesktop = true,
            DesktopIcon = "menu",
            HasWeb = true,
            WebIcon = null,
        ...
        var payRecordMenuModel = new MenuModel
        {
            ...
            ParentIds = [0, financeCLMenuModel.MenuId],
            MenuType = MenuTypeEnum.Menu,
            RoleType = RoleTypeEnum.Admin | RoleTypeEnum.IT | RoleTypeEnum.Finance | RoleTypeEnum.Operator,
            HasDesktop = true,
            DesktopIcon = "lock",
            HasWeb = true,
            WebIcon = null,
        ...
        var wechatUserMenuModel = new MenuModel
        {
            ...
            MenuType = MenuTypeEnum.Menu,
            RoleType = RoleTypeEnum.Admin | RoleTypeEnum.IT | RoleTypeEnum.Operator,
            HasDesktop = true,
            DesktopIcon = "menu",
            HasWeb = true,
            WebIcon = null,
