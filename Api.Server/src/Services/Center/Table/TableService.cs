    ...
    public async Task EditTableColumnConfig(EditTableColumnConfigInput input)
    {
        ...
        var updateTableColumnList = input.Columns.Where(wh => wh.ColumnId != null)
            .Select(sl =>
            {
                ...
                tableColumnModel.Prop = sl.Prop;
                tableColumnModel.Label = sl.Label;
                tableColumnModel.Fixed = sl.Fixed;
                tableColumnModel.AutoWidth = sl.AutoWidth;
                tableColumnModel.Width = sl.Width;
                tableColumnModel.SmallWidth = sl.SmallWidth;
                tableColumnModel.Order = sl.Order;
                tableColumnModel.Show = sl.Show;
                tableColumnModel.Copy = sl.Copy;
                tableColumnModel.Sortable = sl.Sortable;
                tableColumnModel.SortableField = sl.SortableField;
                tableColumnModel.Type = sl.Type;
                tableColumnModel.Link = sl.Link;
                tableColumnModel.ClickEmit = sl.ClickEmit;
                tableColumnModel.Tag = sl.Tag;
                tableColumnModel.Enum = sl.Enum;
                tableColumnModel.DateFix = sl.DateFix;
                tableColumnModel.DateFormat = sl.DateFormat;
                tableColumnModel.AuthTag = sl.AuthTag;
                tableColumnModel.DataDeleteField = sl.DataDeleteField;
                tableColumnModel.Slot = sl.Slot;
                tableColumnModel.OtherConfig = sl.OtherConfig;
                tableColumnModel.PureSearch = sl.PureSearch;
                tableColumnModel.SearchEl = sl.SearchEl;
                tableColumnModel.SearchKey = sl.SearchKey;
                tableColumnModel.SearchLabel = sl.SearchLabel;
                tableColumnModel.SearchOrder = sl.SearchOrder;
                tableColumnModel.SearchSlot = sl.SearchSlot;
                tableColumnModel.SearchConfig = sl.SearchConfig;
