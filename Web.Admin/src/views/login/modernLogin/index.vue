		...
		<el-main>
			<div class="login-glass">
				...
				<transition mode="out-in" name="slide-left">
					<!-- 账号 -->
					<div v-if="formStep === 'Account'" class="login-glass__body" key="account">
						<el-form
							ref="elFormRef"
							labelPosition="top"
							:model="formData"
					...
					<!-- 租户账号 -->
					<div v-else-if="formStep === 'TenantAccount'" class="login-glass__body" key="tenant">
						<div class="tenant-info">
							<span class="tenant-welcome">欢迎回来</span>
							<span>
					...
					<!-- 新账号 -->
					<div v-else-if="formStep === 'NewAccount'" class="login-glass__body" key="new">
						<div class="tenant-info">
							<span class="tenant-welcome">请输入</span>
					...
					<!-- 租户选择 -->
					<div v-else-if="formStep === 'SelectTenant'" class="login-glass__body" key="select">
						<div class="tenant-info">
							<span class="tenant-welcome">请选择</span>
							<span>租户账号进行登录</span>
						</div>
						<div class="right__button-back">
							<el-button
