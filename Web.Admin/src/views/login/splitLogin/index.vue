			...
			<div class="split-login">
				...
				<div class="split-login__brand">
					...
					<div class="brand-content">
						...
						<h1 class="brand-title">
							<span class="brand-title__fast">Fast</span>
							<span class="brand-title__dot">Dotnet</span>
						</h1>
						<p class="brand-subtitle">{{ appStore.appName }} 管理平台</p>
						...
						<p class="brand-copyright">Powered by Fast Dotnet</p>
					</div>
				</div>
				<!-- 右侧登录表单区 -->
				<div class="split-login__form">
					<transition mode="out-in" name="slide-left">
						<!-- 账号 -->
						<div v-if="formStep === 'Account'" class="form-panel" key="account">
							<div class="form-header">
								<h2>欢迎登录</h2>
								<p>{{ appStore.appName }} 管理平台</p>
							</div>
							<el-form
								ref="elFormRef"
								labelPosition="top"
						...
						<!-- 租户账号 -->
						<div v-else-if="formStep === 'TenantAccount'" class="form-panel" key="tenant">
							<div class="form-header">
								<h2>欢迎回来</h2>
								<p>
						...
						<!-- 新账号 -->
						<div v-else-if="formStep === 'NewAccount'" class="form-panel" key="new">
							<div class="form-header">
								<h2>请输入</h2>
								<p>新的租户账号进行登录</p>
							</div>
							<div class="form-back">
								<el-button type="primary" size="default" link :icon="ArrowLeftBold" @click="handleNewAccountBack">
									返回
								</el-button>
							</div>
							<el-form
						...
						<!-- 租户选择 -->
						<div v-else-if="formStep === 'SelectTenant'" class="form-panel" key="select">
							<div class="form-header">
								<h2>请选择</h2>
								<p>租户账号进行登录</p>
							</div>
