				...
				<div class="panel__content">
					...
					<div class="panel__icon">
						<svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<!-- 盾牌 -->
							<path d="M100 40 L140 65 L140 110 Q140 145 100 170 Q60 145 60 110 L60 65 Z" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.5)" stroke-width="2" />
							<!-- 对勾 -->
							<polyline points="80,105 95,120 125,85" stroke="rgba(255,255,255,0.85)" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" fill="none" />
						</svg>
					</div>
					<div class="panel__tagline">
						<h2>{{ appStore.appName }}管理平台</h2>
