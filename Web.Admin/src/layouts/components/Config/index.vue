			...
			<div class="main__box">
				<div class="layout-mode">
					<el-tooltip effect="dark" placement="top" :showAfter="200" content="经典">
						<el-container class="layout-mode__Classic" :class="{ active: configStore.layout.layoutMode === 'Classic' }" @click="configStore.setLayoutMode('Classic')">
							<el-aside />
							<el-container>
								<el-header />
								<el-main />
					...
					<el-tooltip effect="dark" placement="top" :showAfter="200" content="横向">
						<el-container class="layout-mode__Horizontal" :class="{ active: configStore.layout.layoutMode === 'Horizontal' }" @click="configStore.setLayoutMode('Horizontal')">
							<el-header />
							<el-main />
						</el-container>
					</el-tooltip>
					<el-tooltip effect="dark" placement="top" :showAfter="200" content="混合">
						<el-container class="layout-mode__Mixed" :class="{ active: configStore.layout.layoutMode === 'Mixed' }" @click="configStore.setLayoutMode('Mixed')">
							<el-header />
							<el-container>
								<el-aside />
								<el-main />
