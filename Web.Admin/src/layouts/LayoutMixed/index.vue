<template>
	...
	>
		<el-header class="top-header">
			<div class="top-bar" :style="{ '--height': addUnit(configStore.layout.navBarHeight) }">
				<div class="left">
					<LayoutLogo />
					<el-menu
		...
		<el-container>
			...
			<el-container>
				<el-header class="sub-header">
					<div class="sub-bar" :style="{ '--height': addUnit(configStore.layout.navBarHeight - 5) }">
						<div class="left">
							<el-icon
...
import LayoutMenu from "@/layouts/LayoutClassic/components/Menu/index.vue";
